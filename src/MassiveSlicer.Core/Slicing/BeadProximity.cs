...
/// so thinning a layer makes this failure worse.</para>

/// <para><b>Measurement only.</b> This class reports WHERE beads crowd and by how much. It
/// deliberately does not decide what to do about it — no flow factor, no correction, nothing
/// stamped on a move. What to do with a detected arm is a separate decision.</para>
///
