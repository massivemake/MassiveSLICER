...
public sealed class SliceSettings
{
    ...
    /// <summary>
    /// Minimum layer height (mm). Must be ≤ LayerHeight. The floor for EVERY rule that varies
    /// thickness — adaptive layer height and support-driven layer height both read it.
    /// </summary>
    ...
    /// feature flags. <see cref="SupportDrivenLayerHeight"/> was first added without joining that
    /// list and silently handed every layer it thinned a full nominal layer's worth of material —
