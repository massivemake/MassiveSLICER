...
public partial class ViewportView : UserControl
{
    ...
    private void OnRender(TimeSpan delta, int w, int h)
    {
        ...
        // A selected support pocket's own rotation wins; otherwise fall through to main's
        // node-local basis (GetModifierAxisBasis was renamed GetGizmoAxisBasis there).
        _renderer.GizmoAxisBasis = supportAxisBasis ?? GetGizmoAxisBasis(_renderer.SelectedNode);
    ...
    private static SliceSettings BuildSliceSettings(AdditiveSettingsViewModel? additive)
    {
        ...
        return new SliceSettings
        {
            ...
            BrimDirection       = AdditiveSettingsViewModel.ParseBrimDirection(s.BrimDirectionDisplay),
            ...
            ProximityCorrectionEnabled = s.ProximityCorrectionEnabled,
            ProximityMinRunLengthMm    = (float)s.ProximityMinRunLengthMm,
            MaxFlowChangePercentPerSecond = (float)s.MaxFlowChangePercentPerSecond,
            ProximityHoldThroughStructure = s.ProximityHoldThroughStructure,
            ProximityAnticipateExit = s.ProximityAnticipateExit,
    ...
    [
        ...
        nameof(AdditiveSettingsViewModel.ProximityCorrectionEnabled),
        nameof(AdditiveSettingsViewModel.ProximityMinRunLengthMm),
        nameof(AdditiveSettingsViewModel.MaxFlowChangePercentPerSecond),
        nameof(AdditiveSettingsViewModel.ProximityHoldThroughStructure),
        nameof(AdditiveSettingsViewModel.ProximityAnticipateExit),
        ...
        nameof(AdditiveSettingsViewModel.BrimDirectionDisplay),
    ...
    /// world-up. Same shape as <see cref="GetGizmoAxisBasis"/> (rotation about Z only).</summary>
