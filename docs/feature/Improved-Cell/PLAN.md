# Improved Cell Frames — Implementation Plan (TDD)

The **what / why** lives in [README.md](README.md). This file is the task list for implementers.

> **For Hermes:** Use subagent-driven-development skill to implement this plan task-by-task.
> Branch: `feature/Improved-Cell`. Do **not** commit to `main`. This changes robot motion / IK / cell frames — keep it off `main` until LFAM 3 mill scrub + a print export are verified on the machine.
