...
| Send to MassiveDRIVE (v2 dir + pointer, v1 JSON small jobs) | `Core/IO/MassiveDriveJobExporter.cs`, `MassiveDriveJobV2Writer.cs`, `MassiveDriveSegmentBinary.cs`, `MassiveDriveClient.cs`, `ViewportView.SendToMassiveDriveAsync`. Layout: `docs/massivedrive-job-v2.md`. LFAM 3 share: `massiveDriveJobsRoot` in cell JSON. |
